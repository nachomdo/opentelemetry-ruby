...
[xray context propagation format][xray-spec]. There are injectors and extractors for both the
single and multi-header xray variants. They can be in conjunction with each other
...
[xray-spec]: https://github.com/openzipkin/xray-propagation
